...
export function useVADRecorder(settings: AudioSettings) {
  ...
  // Request microphone access and prepare the analyzer and recorder
  ...
  // Toggle between IDLE and active LISTENING/RECORDING states
  ...
  // Remove a recording from the archive and revoke its URL
